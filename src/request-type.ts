...
export interface ClientCapabilities extends vscode.ClientCapabilities {
  ...
  /**
   * The client supports receiving the result solely through $/partialResult
   * notifications for requests from the client
   * to the server.
   */
  streaming?: boolean;
}
...
export interface ServerCapabilities extends vscode.ServerCapabilities {
  ...
  /**
   * The server supports receiving results solely through $/partialResult
   * notifications for requests from the server to
   * the client.
   */
  streaming?: boolean;
}
